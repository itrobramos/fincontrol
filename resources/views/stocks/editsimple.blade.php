    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Editar acción</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div class="col-md-10 col-lg-6">
                <div class="card card-primary">
                    ...
                    <form role="form" method="Post" action="{{ url('/stockssimple/' .$stock->id) }}" enctype="multipart/form-data">
                        {{ csrf_field()}}
                        {{ method_field('PATCH')}}
                        <div class="card-body">
                        ...
                        <div class="card-footer d-flex">
                            <a href="{{url('stocks')}}"><button type="button" class="btn btn-danger p-2">Regresar</button></a>
