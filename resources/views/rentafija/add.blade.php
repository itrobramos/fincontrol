    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Registrar Inversión</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <form role="form" method="POST" action="{{ url('/rentafija') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="platform" value="{{$platform->name}}" readonly class="form-control">
                                <input type="hidden" name="platformId" value="{{$platform->id}}" class="form-control">
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" name="term" class="form-control" id="term">
                                    <br>
                                        <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input termType" type="radio" id="customRadio1" name="termType" value="days">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="initialDate" id="fechaInicio" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="FechaFin">Fecha Fin</label>
                                        <input type="date" name="endDate" id="fechaFin" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" name="paidDay" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="Pago">Rendimiento cada __ día:</label>
                                        <input type="number" step="any" name="fixedDay" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                  <input type="checkbox" class="custom-control-input" id="customSwitch1" name="reinvest">
