                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="/fibras">Fibras</a></li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-md-3 col-lg-3 col-xl-3">
                            <div class="card mb-2 bg-gradient-dark">
                                <img class="card-img-top" src="{{env('DEPLOY_URL')}}/{{$userstock->stock->imageUrl}}" alt="Logo">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3">
                            ...
                            <div class="inner">
                                <h3><sup style="font-size: 20px">$</sup>{{$userstock->quantity * $userstock->averagePrice}}</h3>
                                <p>Inversión</p>
                            </div>
                            <div class="icon">
                            ...
                            <div class="card">
                              <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="#dividends" data-toggle="tab">Dividendos</a></li>
