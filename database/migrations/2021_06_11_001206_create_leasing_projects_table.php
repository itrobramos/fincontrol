...
class CreateLeasingProjectsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('leasing_projects', function (Blueprint $table) {
            $table->id();
            $table->string('name');
        ...
        Schema::table('leasing_projects', function (Blueprint $table){
    ...
    {
        Schema::dropIfExists('leasing_projects');
    }
}
